...
<html>
    ...
    <body background="bg.gif">
        <%@include file="WEB-INF/Pages/cafe/cafeHeader.jsp" %>
        ...
        <div style="margin-left: 23%; background-color: #ffffff; margin-top: 1%; box-shadow: 0px 0px 4px 0px; width: 60%;"><br>
            <iframe style="margin-left: -85%; margin-top: 2%;"  height="200px" width="200px"  src="<s:url value="findUser"><s:param name="id" value="%{userID}"  /></s:url>" frameborder="0" name="imgbox" id="imgbox" >         
                </iframe>
            ...
            <div style="   float: left">     
                <s:form action="placeOrder" method="post">
                    ...
                    <s:hidden name="rfid" />            
                    <br/>
                    <div  style="margin-top: 2%; margin-left:55%;">
