...
<html>
    ...
    <s:head />
    <body  onload="noBack();" onpageshow="if (event.persisted) noBack();"  onunload="" background="bg.gif" style="background-position:center;">
	...
	<!--/.navbar-inner -->
        ...
        <%-- <div style="margin-left: 28%; margin-top: 5%; width: 50%; background-color: #ffffff; box-shadow: 0px 0px 4px 0px;">
         
         <s:form id="myform" cssClass="form-horizontal" action="loginCheck" method="POST" >
             <fieldset>
                 <div id="legend">
                 ...
                 <div class="control-group">
                     ...
                     <div class="controls">
                        ...
                        <s:textfield cssClass="validate[required] input-xlarge" name="userID" id="userID"   />
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <s:password cssClass="validate[required] input-xlarge" name="pass" id="pass"/>
                    </div>
                </div>
        ...
        <div style="margin-left: 38%;"><a href="signUp">Register</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="forgot">Forgot Password</a></div>
        ...
        <div id="wrapper">
            ...
            <s:form  name="login-form" id="myform" cssClass="login-form" action="loginCheck" method="post">
                <br>
                ...
                <div class="content">
                    ...
                    <s:textfield name="userID" cssClass="input username validate[required]" placeholder="User name" /> 
                    <div class="user-icon"></div>
                    <!--	<input type="password" name="pass"  class="input password" placeholder="Password" /> -->
                    <s:password name="pass" cssClass="input password validate[required,minSize[6]]" placeholder="Password"/>
                    <div class="pass-icon"></div>		
                </div>

                <div style="height:5%;" class="footer" style="display: inline;">
                    <s:submit  value="Login" cssClass="button" style="display:inline;" /><br><br>
                    <a href="signUp"  style="margin-left: 12%;">Register</a>&nbsp;|&nbsp;<a href="forgot" >Forgot Password</a>
                </div>
