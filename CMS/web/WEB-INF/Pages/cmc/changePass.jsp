...
%>
    ...
    <body background="bg.gif">
        <div>
            <%@include  file="CMCHeader.jsp" %><br/><br/>  
            ...
            <div style="float:left;background-color:#ffffff; margin-left: 10%; margin-top: -2.5%;  width: 80%;">
                    ...
                    <div  class="well">
                        ...
                        <div id="myTabContent" class="tab-content">
                            <div class="tab-pane active in" id="home">
                                ...
                                <s:form action="changeCMCPassword" method="post" id="myform">
