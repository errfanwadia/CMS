...
<html>
    ...
    <body onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="">    
        ...
        <ul class="nav nav-tabs" style="width: 50%; margin-left:10%;">
            <li class="active"><a href="home" >Purchase History</a></li>
            <li class=""><a href="rechargeHistory" >Recharge History</a></li>
            <li class=""><a href="transferHistory" >Transfer History</a></li>
        </ul>
