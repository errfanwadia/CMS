...
<!DOCTYPE html>
<html>
    <head> <title>Order History Page</title>
...
%>
    ...
    <body onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="">    
        ...
        <ul class="nav nav-tabs" style="width: 50%; margin-left:10%;">
            <li class="active"><a href="home" >Orders History</a></li>
            <li class=""><a href="rollbackedHistory" >Rollbacked Orders</a></li>
            <li class=""><a href="withdrawHistory" >Withdraw History</a></li>
        </ul>
                    ...
                    <s:iterator value="tran">
                        <tr style="text-align: center;width: 100%;">                               
                            ...
                            <s:if test="type == \"sold\" ">
                                ...
                                <s:if test="is_rollbacked == \"0\" ">

                                    <td><a href="<s:url action="rollback" value="rollback"> <s:param name="t_id" value="%{t_id}"  /> </s:url>" >Rollback</a> </td>

                                </s:if>    
                                <s:else>

                                    <td>Already Rollbacked</td>
                                </s:else>
                            </s:if> 
                            <s:else>
