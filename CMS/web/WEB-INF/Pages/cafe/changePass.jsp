...
<html>
    ...
    <body>
        <div>
            <%@include  file="cafeHeader.jsp" %><br/><br/>            
                    ...
                    <div  class="well">
                        ...
                        <div id="myTabContent" class="tab-content">
                            <div class="tab-pane active in" id="home">
                                ...
                                <s:form action="changePassword" method="post" id="myform">
                                    ...
                                    <!--<input type="text" value="jsmith" class="input-xlarge">-->
                                    <s:password cssClass="validate[required,minSize[6]]" id="newpass" name="newpass" class="input-xlarge"/><br/><br/>

                                    <s:label value="Re-type Password:" />
                                    <!--<input type="text" value="jsmith" class="input-xlarge">-->
                                    <s:password name="newpass2" cssClass="validate[required,equals[newpass]]" class="input-xlarge"/><br/><br/>
